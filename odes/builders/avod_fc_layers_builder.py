...
from odes.core.avod_fc_layers import basic_fc_layers
from odes.core.avod_fc_layers import fusion_fc_layers
from odes.core.avod_fc_layers import d2_fc_layers
...
def build(layers_config,
        ...
        if fc_layers_type == 'basic_fc_layers':
            ...
            cls_logits, offsets, angle_vectors, end_points = \
                fusion_fc_layers.build(
                    ...
                    is_training=is_training,
                    end_points_collection=end_points_collection)
        elif fc_layers_type == 'd2_fc_layers':
    ...
    # # Histogram summaries
    # with tf.variable_scope('histograms_odes'):
