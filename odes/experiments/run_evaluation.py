...
ODES_ROOT = os.path.dirname(os.path.dirname(BASE_ROOT))
sys.path.append(ODES_ROOT)
sys.path.append(os.path.join(ODES_ROOT, 'wavedata'))
...
from odes.core.evaluator import Evaluator
...
def evaluate(model_config, eval_config, dataset_config):
    ...
    with tf.Graph().as_default():
        model = OdesModel(model_config, train_val_test=eval_mode,
                              dataset=dataset)
