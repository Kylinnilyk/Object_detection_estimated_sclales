...
import odes
from odes.core import box_3d_projector
...
def save_predictions_in_kitti_format(model,
    ...
    for sample_idx in range(num_samples):
        ...
        score_filter = all_predictions[:, 4] >= score_threshold  ## benz, confidence should be 4th element
...
def run_kitti_native_script_with_05_iou(checkpoint_name, score_threshold,
    ...
    results_dir = odes.top_dir() + '/scripts/offline_eval/results_05_iou/'
