...
def project_3d_box_to_image_space(box_3d, stereo_calib_p2, image_shape):
    ...
    x_corners = np.array([x +  l/2.0*np.cos(ry) + w/2.0*np.sin(ry), # dim_x_half,
                          ...
                          x -  l/2.0*np.cos(ry) + w/2.0*np.sin(ry), #+ dim_x_half,
                          x -  l/2.0*np.cos(ry) - w/2.0*np.sin(ry), #- dim_x_half,
                          x +  l/2.0*np.cos(ry) - w/2.0*np.sin(ry) ]).T.reshape(1, -1)
    ...
    z_corners = np.array([z - l/2.0*np.sin(ry) + w/2.0*np.cos(ry),
                          ...
                          z + l/2.0*np.sin(ry) + w/2.0*np.cos(ry),  #- dim_z_half,
                          z + l/2.0*np.sin(ry) - w/2.0*np.cos(ry),  #- dim_z_half,
                          z - l/2.0*np.sin(ry) - w/2.0*np.cos(ry) ]).T.reshape(1, -1)
