...
from odes.builders import bev_generator_builder
from odes.core.label_cluster_utils import LabelClusterUtils
from odes.core.mini_batch_utils import MiniBatchUtils
...
class KittiUtils(object):
    ...
    def get_img_roi_data(self, classes_name, anchor_strides, sample_name):
        ...
        all_img_roi_info = self.mini_batch_utils.get_img_roi_data(classes_name,
                                                              anchor_strides,
                                                              sample_name)
        return all_img_roi_info
