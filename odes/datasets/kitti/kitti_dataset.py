...
from odes.datasets.kitti.kitti_utils import KittiUtils
...
class KittiDataset:
    ...
    def get_img_roi_data(self, sample_name):
        return self.kitti_utils.get_img_roi_data(
            self.classes_name,
            self.kitti_utils.anchor_strides,
            sample_name)
    ...
    def load_samples(self, indices):
        ...
        for sample_idx in indices:
            ...
            if self.has_labels:
                ...
                if (not anchors_info) and self.train_val_test == 'train' \
                    ...
                    empty_sample_dict = {
                        ...
                        constants.KEY_IMG_ROI_ALL:img_roi_all
                    }
            ...
            if kitti_aug.AUG_FLIPPING in sample.augs:
                ...
                img_roi_all = kitti_aug.flip_roi(img_roi_all[0],image_shape), kitti_aug.flip_roi_norm(img_roi_all[1])
                if anchors_info:
            ...
            if obj_labels is not None:
                ...
                if kitti_aug.AUG_FLIPPING in sample.augs:
                    label_boxes_2d = kitti_aug.flip_roi(label_boxes_2d, image_shape)
